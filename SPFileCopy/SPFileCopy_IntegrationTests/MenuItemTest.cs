...
namespace SPFileCopy_IntegrationTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(Britehouse.SPFileCopy.GuidList.guidSPFileCopyCmdSet, (int)Britehouse.SPFileCopy.PkgCmdIDList.cmdidUpdateFileReferences);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "SPFileCopy", "Britehouse.SPFileCopy.SPFileCopyPackage");
