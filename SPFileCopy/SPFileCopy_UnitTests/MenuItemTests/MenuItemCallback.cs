...
using Britehouse.SPFileCopy;

namespace SPFileCopy_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new SPFileCopyPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(Britehouse.SPFileCopy.GuidList.guidSPFileCopyCmdSet, (int)Britehouse.SPFileCopy.PkgCmdIDList.cmdidUpdateFileReferences);
